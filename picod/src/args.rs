...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("picod")
        .about(format!("{} (rusty-picod) v{}", env!("CARGO_PKG_DESCRIPTION"), version()))
        ...
        .arg(
            Arg::new("rpclisten")
                ...
                .help("Interface:port to listen for gRPC connections (default port: 16110, testnet: 16668)."),
        )
        .arg(

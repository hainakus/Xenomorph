...
pub enum Prefix {
    #[serde(rename = "xenom")]
    Mainnet,
    #[serde(rename = "xenomtest")]
    Testnet,
    #[serde(rename = "xenomsim")]
    Simnet,
    #[serde(rename = "xenomdev")]
    Devnet,
    #[cfg(test)]
    A,
    #[cfg(test)]
...
mod tests {
    ...
    fn test_errors() {
        // cspell:disable
        let address_str: String = "xenom:qqqqqqqqqqqqq1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqkx9awp4e".to_string();
        ...
        let address_str: String = format!("xenom:qqqqqqqqqqqqq{invalid_char}qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqkx9awp4e");
        let address: Result<Address, AddressError> = address_str.try_into();
        ...
        let address_str: String = "xenom1:qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqkx9awp4e".to_string();
        let address: Result<Address, AddressError> = address_str.try_into();
        assert_eq!(Err(AddressError::InvalidPrefix("xenom1".into())), address);

        let address_str: String = "xenomqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqkx9awp4e".to_string();
        let address: Result<Address, AddressError> = address_str.try_into();
        assert_eq!(Err(AddressError::MissingPrefix), address);

        let address_str: String = "xenom:qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqkx9awp4l".to_string();
        let address: Result<Address, AddressError> = address_str.try_into();
        assert_eq!(Err(AddressError::BadChecksum), address);

        let address_str: String = "xenom:qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqkx9awp4e".to_string();
        let address: Result<Address, AddressError> = address_str.try_into();
        assert_eq!(Err(AddressError::BadChecksum), address);
        // cspell:enable
    }
    ...
    pub fn test_wasm_serde_constructor() {
        let str = "xenom:qpauqsvk7yf9unexwmxsnmg547mhyga37csh0kj53q6xxgl24ydxjsgzthw5j";
    ...
    pub fn test_wasm_js_serde_object() {
        let expected = Address::constructor("xenom:qpauqsvk7yf9unexwmxsnmg547mhyga37csh0kj53q6xxgl24ydxjsgzthw5j");
        ...
        obj.set("prefix", &JsValue::from_str("xenom")).unwrap();

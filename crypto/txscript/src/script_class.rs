...
pub enum ScriptClass {
    ...
    /// Pay to script hash
    ScriptHash,
    /// Pay to post-quantum pubkey hash (ML-DSA-65 / Dilithium3)
    PubKeyPQ = 4,
}
...
impl ScriptClass {
    pub fn from_script(script_public_key: &ScriptPublicKey) -> Self {
        ...
        if script_public_key.version() == MAX_SCRIPT_PUBLIC_KEY_VERSION {
            if Self::is_pay_to_pubkey(script_public_key_) {
                ...
                Self::ScriptHash
            } else if Self::is_pay_to_pubkey_pq(script_public_key_) {
                Self::PubKeyPQ
            } else {
    ...
    /// Returns true if the script is a pay-to-PQ-pubkey-hash (P2PQKH) script:
    ...
    fn as_str(&self) -> &'static str {
        match self {
            ...
            ScriptClass::PubKeyPQ => PUB_KEY_PQ,
        }
    }
    ...
    pub fn version(&self) -> ScriptPublicKeyVersion {
        match self {
            ...
            ScriptClass::PubKeyPQ => MAX_SCRIPT_PUBLIC_KEY_VERSION,
        }
    }
}
...
impl FromStr for ScriptClass {
    ...
    fn from_str(script_class: &str) -> Result<Self, Self::Err> {
        match script_class {
            ...
            PUB_KEY_PQ => Ok(ScriptClass::PubKeyPQ),
...
impl From<Version> for ScriptClass {
    fn from(value: Version) -> Self {
        match value {
            ...
            Version::PubKeyPQ => ScriptClass::PubKeyPQ,

...
mod tests {
    ...
    fn test_pow_hash() {
        ...
        let mut hasher = blake3::Hasher::new();
        hasher.update(&pre_pow_hash.0).update(&timestamp.to_le_bytes()).update(&[0u8; 32]).update(&nonce.to_le_bytes());
    ...
    fn test_heavy_hash() {
        ...
        let hash2 = Hash::from_bytes([
            0xe3, 0x69, 0xd9, 0xa9, 0xab, 0x79, 0x36, 0x22, 0xe8, 0xfc, 0x83, 0xb6, 0xbc, 0xb5, 0x40, 0xf5, 0x53, 0x51, 0x0c, 0x8a,
            0xdf, 0x5b, 0x9b, 0x99, 0x64, 0x98, 0x2e, 0x83, 0x48, 0x11, 0x76, 0x26,
        ]);

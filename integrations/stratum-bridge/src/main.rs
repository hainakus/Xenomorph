...
fn cli() -> Command {
    Command::new("xenom-stratum-bridge")
        ...
        .arg(Arg::new("mining-address")
            .long("mining-address").short('a').value_name("ADDRESS")
        ...
        .arg(Arg::new("min-payout-sompi")
            ...
            .default_value("20000000000").value_parser(clap::value_parser!(u64))
            .help("Minimum per-miner payout in sompi (default: 20000000000 = 200 XENOM)"))

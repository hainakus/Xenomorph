...
mod tests {
    ...
    fn test_heavy_hash() {
        let expected_hash = Hash::from_bytes([
            0xca, 0x43, 0x9f, 0xcf, 0x8e, 0x0d, 0x35, 0xf1, 0x6c, 0xe1, 0x7a, 0xcf, 0xfc, 0xa4, 0xbd, 0xd9, 0xc9, 0x1d, 0x8c, 0x2b,
            0x62, 0xda, 0x93, 0x4a, 0xe6, 0x16, 0xe8, 0xed, 0x4f, 0xc7, 0x58, 0x18,
        ]);
        #[rustfmt::skip]
